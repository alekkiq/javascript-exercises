...
function createCard(article) {
  ...
  figCaption.textContent = article.caption;
  ...
  // append all created elements to the core element
...
// creates each card & set up the click event
function initializeCards() {
  picArray.forEach((article, index) => {
